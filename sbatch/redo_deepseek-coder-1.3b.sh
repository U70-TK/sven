#!/bin/bash
# End-to-end redo for deepseek-coder-1.3b-prefix after the tokenizer fix + retrain.
# Usage:  bash sbatch/redo_deepseek-coder-1.3b.sh
# Requires: a GPU (the gen phase loads the model); CodeQL phase is CPU-only.
set -e

SVEN_ROOT=/u901/t577wang/sven
MODEL=deepseek-coder-1.3b-prefix
